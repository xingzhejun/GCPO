...
pip install transformers==4.45.2 accelerate==1.0.1 tokenizers==0.20.1 albumentations==1.4.20 av==13.1.0 \
...
regex==2024.9.11 requests==2.31.0 scikit-learn==1.5.2 scipy==1.13.0 six==1.16.0 test-tube==0.7.5 \
...
moviepy==1.0.3 wandb==0.18.5 pydantic==2.9.2 huggingface_hub==0.26.1 protobuf==5.28.3 watch \
gpustat peft==0.13.2 liger_kernel==0.4.1 einops==0.8.0 wheel==0.44.0 loguru diffusers==0.32.0 bitsandbytes==0.44.1
