        ...
        try:
            with torch.inference_mode():
                    ...
                    for idx, video_name in enumerate(data["filename"]):
                        ...
                        # print('prompt_embeds shape is:', prompt_embeds.shape) # （bsz, 512, 4096)
                        # print('pooled_prompt_embeds shape is:', pooled_prompt_embeds.shape) # (bsz, 768)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vae_debug", action="store_true") # False
